...
- **Commodity knowledge:** `supabase/functions/_shared/commodity-knowledge.ts` — distilled trading frameworks from 3 PDF books (~4K tokens). Injected into Step 3.5 Flash system prompt for domain expertise.
