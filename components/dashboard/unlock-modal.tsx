        ...
        {unlocked ? (
          ...
          <>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Add {grain} to your crop plan to unlock its intelligence dashboard. Acres open the page now; starting grain, remaining tonnes, deliveries, and X feedback make the AI more specific to your farm over time.
              </CardDescription>
            </CardHeader>
            <CardContent>
