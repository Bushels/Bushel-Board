...
/**
 * Real GeoJSON boundaries for the three prairie provinces.
 * Coordinate pairs are [lng, lat] in WGS84, rounded to 2 decimals.
 * Source: Statistics Canada / Natural Resources Canada via public datasets.
 * ~333 total vertices — small enough to embed (~5KB).
 */
