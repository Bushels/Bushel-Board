...
const sampleRows: SeismographRow[] = [
  {
    ...
    planted_pct_previous_year: 22, planted_pct_yoy_change: 3,
    emerged_pct_previous_year: 5, emerged_pct_yoy_change: 2,
  ...
  },
  {
    ...
    planted_pct_previous_year: 51, planted_pct_yoy_change: 4,
    emerged_pct_previous_year: 19, emerged_pct_yoy_change: 3,
  ...
  },
  {
    ...
    planted_pct_previous_year: 20, planted_pct_yoy_change: -2,
    emerged_pct_previous_year: 6, emerged_pct_yoy_change: -2,
    good_excellent_pct: 35, condition_index: 2.4, ge_pct_yoy_change: -19,
    planted_acres: 6_100_000,
  },
];
