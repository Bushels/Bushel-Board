...
| `collect-gee-crop-stress` | `0 17 * * 1` | Mon | 5:00 PM | 7:00 PM | Google Earth Engine (MODIS NDVI + SMAP /008 + CDL/ESA WorldCover) | `gee_crop_stress` |
