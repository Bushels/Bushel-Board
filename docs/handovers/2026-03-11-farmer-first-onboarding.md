...
- [x] Removed the duplicate grain-page X preview strip so social context appears once, in the evidence/feed layer only
...
- `app/(dashboard)/grain/[slug]/page.tsx` - removed the duplicate top-level X preview from the grain page hierarchy
