...
| 50 | Data Layer Foundation V1 | In progress | 2026-05-02 | Branch `codex/data-layer-foundation-v1`, commit `18a0935`. Local contracts now exist for `source_runs`, grain/market mapping registry, source freshness view/RPC, importer run summaries, and Canada/US facts-only thesis packet RPCs. Live Supabase apply is blocked by remote-only migration version `20260429100000`. |
