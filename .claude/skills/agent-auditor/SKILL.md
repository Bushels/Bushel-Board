...
- `../../.agents/skills/_eval-core/framework.md`
- `../../.agents/skills/_eval-core/rubric.md`
- `../../.agents/skills/_eval-core/replay-policy.md`
- `../../.agents/skills/_eval-core/promotion-rules.md`
- `../../.agents/skills/_eval-core/report-template.md`
...
```bash
python ../../.agents/skills/_eval-core/scripts/score_audit.py --mode agent --evidence-level observed --scores-json '{"task_success":4,"instruction_compliance":4,"orchestration_quality":3,"context_management":3,"escalation_judgment":4,"safety":5,"efficiency":3}' --pretty
```
