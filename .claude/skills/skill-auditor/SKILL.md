...
```bash
python ../../.agents/skills/_eval-core/scripts/score_audit.py --mode skill --evidence-level observed --scores-json '{"task_success":4,"instruction_compliance":4,"trigger_quality":3,"resource_leverage":3,"tool_hygiene":4,"safety":5,"efficiency":3}' --pretty
```
